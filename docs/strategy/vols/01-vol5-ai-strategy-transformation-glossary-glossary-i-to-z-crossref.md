---
title: "AI Strategy & Transformation Glossary: I-Z & Cross-Reference"
doc_type: glossary
domain: strategy
status: current
canonical: true
topic_id: vol5-ai-strategy-transformation-glossary-part4
maturity: expert
...
Continuation of the master glossary with terms I-Z, followed by essential concept-to-concept relationships.
...
## Essential Concept-to-Concept Relationships
...
- [Master Glossary A-H](../99-vol5-ai-strategy-transformation-glossary-glossary-a-to-h.md)
- [AI Strategy Framework](../48-vol5-ai-strategy-transformation-glossary.md)
- [All Volume Indices](../43-vol1-corporate-strategy.md)
