---
title: "Portfolio Consulting Frameworks: PMO Evolution & Strategy"
doc_type: guide
domain: strategy
status: current
canonical: true
topic_id: vol8-portfolio-consulting-frameworks-part2
...
### Traditional PMO → Agile PMO → AI-Augmented PMO
...
Large-scale transformation programs require a dedicated Transformation Office (TO) distinct from traditional PMO:
...
### OKR Integration with Portfolio

OKRs translate strategy into measurable commitments. When integrated with portfolio management, they close the strategy-execution gap:
...
## Strategy Frameworks Deep Dive

### McKinsey 7S Framework

**Origin:** Tom Peters and Robert Waterman at McKinsey, 1980.
...
- AI transformation alignment assessment
...
**Core Concept:** Portfolio classification based on market share and market growth.

```
HIGH GROWTH    STARS (Invest/Grow)    QUESTION MARKS (Evaluate/Bet)
LOW GROWTH     CASH COWS (Harvest)    DOGS (Divest/Fix)
               HIGH SHARE             LOW SHARE
```

**Digital Era Adaptation:**

| Category | Digital Era Nuance |
|----------|-------------------|
| **Stars** | Platform businesses with network effects; AI-native products |
| **Cash Cows** | Core SaaS with high retention; digital operations |
| **Question Marks** | New AI products; experimental features |
| **Dogs** | Legacy on-premise; technical debt |
...
| Force | Traditional | AI Disruption |
|-------|------------|---------------|
| **Competitive Rivalry** | Brand, cost, features | AI rapidly replicates features; speed of innovation increases |
| **Threat of New Entrants** | Capital, regulations, distribution | AI lowers barrier to entry in knowledge work |
| **Threat of Substitutes** | Alternative products | AI creates entirely new substitutes (LLM replaces research analysts) |
| **Supplier Power** | Few suppliers = high power | Foundation model providers have power; open source constrains it |
| **Buyer Power** | Many buyers = low power | AI price comparison, switching reduce costs |

### Ansoff Matrix

**Core Concept:** Growth strategies based on existing/new markets and products.
...
|-------------|---------------|
| **Market Penetration** | Use AI to sell more of existing products (personalization, pricing) |
| **Product Development** | AI-enhance existing products (copilots, smart features) |
| **Market Development** | Use AI to enter new segments cost-effectively |
| **Diversification** | AI-native new businesses serving new markets |
...
- [Portfolio Consulting Frameworks: Architecture & Operating Delivery](09-vol8-portfolio-consulting-frameworks-architecture-operating-delivery.md)
---

*Volume 8 of 10 — Part 2 of 4*
