---
title: "Corporate Strategy: Vision, Mission, Purpose & Intent"
doc_type: guide
domain: strategy
status: current
canonical: true
topic_id: vol1-corporate-strategy
maturity: expert
personas: [Chief Strategy Officer, Enterprise Architect, Management Consultant, Executive Leadership]
last_reviewed: 2026-07-19
covers_version: ""
supersedes:
  - docs/enterprise-strategy/vol1-corporate-strategy.md
tags:
  - corporate-strategy
  - strategic-planning
  - vision
...
```mermaid
graph TD
    A["Purpose<br/>(Why we exist beyond profit)"] --> B["Vision<br/>(What we want to become)"]
    B --> C["Mission<br/>(What we do today)"]
    C --> D["Strategic Intent<br/>(3-5 year ambition)"]
    D --> E["Strategic Themes<br/>(3-7 focus areas)"]
    E --> F["Strategic Priorities<br/>(ranked choices)"]
    F --> G["Strategic Objectives<br/>(measurable outcomes)"]
    G --> H["Strategic Initiatives<br/>(funded efforts)"]
    H --> I["Programs & Projects<br/>(delivery vehicles)"]
```
