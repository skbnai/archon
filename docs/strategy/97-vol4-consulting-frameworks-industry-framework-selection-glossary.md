---
title: "Consulting Frameworks: Selection Guide & Glossary"
doc_type: guide
domain: strategy
status: current
canonical: true
topic_id: vol4-consulting-frameworks-industry-part4
maturity: expert
personas: [Chief Strategy Officer, Consultant, Strategy Team]
...
```mermaid
graph TD
    START["START<br/>What problem are<br/>you solving?"]
    
    E["Environment Unknown<br/>PESTLE + Five Forces"]
    SD["Choose Direction<br/>Ansoff + SWOT/TOWS"]
    RA["Allocate Resources<br/>BCG + Portfolio Mgmt"]
    CA["Understand Advantage<br/>VRIO + Porter Strategies"]
    ORG["Design Organization<br/>7S + Operating Model"]
    EXE["Track Execution<br/>OKR + Balanced Scorecard"]
    ARCH["Design Technology<br/>TOGAF + BIZBOK"]
    PLAT["Plan Platform<br/>Platform Strategy + BMC"]
    AI["Assess AI Position<br/>VRIO AI + Wardley Map"]
    INNOV["Plan Innovation<br/>3 Horizons + Blue Ocean"]
