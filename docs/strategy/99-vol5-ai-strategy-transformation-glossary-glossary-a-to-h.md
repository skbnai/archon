---
title: "AI Strategy & Transformation Glossary: A-H"
doc_type: glossary
domain: strategy
status: current
canonical: true
topic_id: vol5-ai-strategy-transformation-glossary-part3
maturity: expert
personas: [All strategy professionals, architects, consultants]
...
This glossary covers all essential terms used across the enterprise strategy and AI transformation domains. Cross-references to source sections are provided for deeper exploration.
...
**Digital Transformation** — Enterprise-wide change using digital technologies to create new or modify existing business processes. [Vol 5, Part 3]
...
- [Master Glossary I-Z & Cross-Reference](vols/01-vol5-ai-strategy-transformation-glossary-glossary-i-to-z-crossref.md)
