---
title: "Corporate Strategy: Themes, Priorities & Initiatives"
doc_type: guide
domain: strategy
status: current
canonical: true
topic_id: vol1-corporate-strategy-part2
maturity: expert
personas: [Chief Strategy Officer, Chief Operating Officer, Program Manager]
...
```mermaid
graph TD
    A["HIGH IMPACT<br/>HIGH EFFORT"] --> B["Strategic Bets<br/>Invest & Explore"]
    C["HIGH IMPACT<br/>LOW EFFORT"] --> D["Must-Do Now<br/>Execute with Urgency"]
    E["LOW IMPACT<br/>HIGH EFFORT"] --> F["Defer/<br/>Deprioritize"]
    G["LOW IMPACT<br/>LOW EFFORT"] --> H["Quick Wins"]
```
...
```mermaid
graph TD
    A["Strategic Portfolio"] --> B["RUN<br/>Keep the lights on"]
    A --> C["GROW<br/>Enhance capabilities"]
    A --> D["TRANSFORM<br/>Build the future"]
    B --> B1["Compliance & regulatory"]
    B --> B2["Maintenance & support"]
    C --> C1["Customer experience"]
    C --> C2["Process automation"]
    D --> D1["AI platforms"]
    D --> D2["Cloud migration"]
    D --> D3["New business models"]
```
...
graph TD
    ...
    L1["Layer 1: Strategic Outcomes<br/>What we will have achieved<br/>by each major milestone"]
    L2["Layer 2: Capability Builds<br/>Which new capabilities are<br/>required and when"]
    L3["Layer 3: Initiative Delivery<br/>Which programs and initiatives<br/>are executing"]
    L4["Layer 4: Enablers<br/>What platform, talent, and<br/>technology enables the above"]
