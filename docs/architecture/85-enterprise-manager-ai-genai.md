...
domain: architecture
topic_id: enterprise-manager-ai-genai
status: current
...
```mermaid
graph TD
    A["Enterprise Manager<br/>Human-AI Orchestrator"] --> B["Core Responsibilities"]
    B --> B1["Outcome Delivery"]
    B --> B2["Human-AI Team Leadership"]
    B --> B3["AI-Powered Performance Management"]
    B --> B4["Continuous Improvement"]
    B --> B5["Stakeholder Management"]
    B --> B6["Talent Development"]
    
    A --> C["Transformation Imperatives"]
    C --> C1["Leadership Style<br/>Command & Control → Coach & Empower"]
    C --> C2["Team Model<br/>Humans Only → Human + AI Blend"]
    C --> C3["Decision-Making<br/>Gut Feel → AI-Augmented Insights"]
    
    A --> D["RFP & Delivery Strategy"]
    D --> D1["Discovery & Qualification"]
    D --> D2["Operating Model Design"]
    D --> D3["Proposal Construction"]
    D --> D4["Mobilisation"]
    
    A --> E["Guiding Principles"]
    E --> E1["Curiosity Over Fear"]
    E --> E2["Coach Mindset"]
    E --> E3["Outcome Obsession"]
    E --> E4["Radical Transparency"]
